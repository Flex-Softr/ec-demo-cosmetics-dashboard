...
import { useGetOrderStatusCountQuery } from "@/redux/features/dashboard/dashboardApi";
...
const OrderStatus = () => {
  const { data: res, isLoading } = useGetOrderStatusCountQuery();
  ...
  return (
    <div className="rounded-xl border bg-white/50 backdrop-blur-sm overflow-hidden md:col-span-2">
